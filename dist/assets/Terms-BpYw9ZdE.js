  ...
  p = () => {
    const s = [
      {
        ...
        content:
          "By accessing and using the Al Nabi Hospital website (alnabihospital.com), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.",
      },
      {
        id: "use-license",
        title: "Use License",
    ...
    return e.jsxs("div", {
      ...
      children: [
        e.jsxs("section", {
          className:
            "relative py-16 bg-gradient-to-br from-primary-600 to-primary-800 overflow-hidden",
          children: [
                ...
                children: [
                  e.jsx("div", {
                    ...
                    children: e.jsx("div", {
                      ...
                      children: e.jsx(m, { className: "h-8 w-8 text-white" }),
                    }),
                  }),
                  e.jsx("h1", {
                  ...
                  e.jsxs("div", {
                    className:
                      "flex items-center justify-center space-x-2 text-blue-100",
                    children: [
        ...
        e.jsx("section", {
          ...
          children: e.jsx("div", {
            ...
            children: e.jsxs(i.div, {
              ...
              viewport: { once: !0 },
              className:
                "bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 md:p-8",
              children: [
                e.jsxs("h2", {
                  className:
                    "text-2xl font-bold text-gray-900 mb-6 flex items-center",
                  children: [
                    e.jsx(n, { className: "h-6 w-6 text-primary-500 mr-2" }),
                    "Table of Contents",
                  ],
                }),
                e.jsx("div", {
                  ...
                  children: s.map((t, a) =>
                    e.jsxs(
                      i.a,
                      {
                        ...
                        viewport: { once: !0 },
                        className:
                          "flex items-center space-x-3 p-3 rounded-lg hover:bg-white/60 transition-colors duration-200 group",
                        children: [
                          e.jsx("span", {
                            className:
                              "w-6 h-6 bg-primary-100 text-primary-600 rounded-full flex items-center justify-center text-sm font-semibold group-hover:bg-primary-200 transition-colors",
                            children: a + 1,
                          }),
                          e.jsx("span", {
                            className:
                              "text-gray-700 group-hover:text-primary-600 transition-colors",
                            children: t.title,
                          }),
                        ],
                      },
                    ...
                    children: [
                      e.jsxs("h2", {
                        ...
                        children: [
                          e.jsx("span", {
                            className:
                              "w-8 h-8 bg-gradient-to-br from-primary-500 to-primary-600 text-white rounded-lg flex items-center justify-center text-sm font-bold mr-3",
                            children: a + 1,
                          }),
                          t.title,
                        ],
        ...
        e.jsx("section", {
          className:
            "py-12 bg-gradient-to-r from-amber-50 to-orange-50 border-t border-gray-200",
          children: e.jsx("div", {
            className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8",
            children: e.jsx(i.div, {
              ...
              viewport: { once: !0 },
              className:
                "bg-white rounded-2xl shadow-lg p-6 md:p-8 border-l-4 border-amber-400",
              children: e.jsxs("div", {
                className: "flex items-start space-x-4",
                children: [
                  e.jsx("div", {
                    className: "flex-shrink-0",
                    children: e.jsx(l, { className: "h-8 w-8 text-amber-500" }),
                  }),
                  e.jsxs("div", {
                    children: [
                      e.jsx("h3", {
                      ...
                      e.jsx("p", {
                        ...
                        children:
                          "These terms and conditions are subject to change without notice. We recommend reviewing this page periodically to stay informed of any updates. Your continued use of our website constitutes acceptance of any changes to these terms.",
                      }),
                      e.jsx("p", {
        ...
        e.jsx("section", {
          className: "py-16 bg-gradient-to-br from-primary-600 to-primary-800",
          children: e.jsx("div", {
            ...
            children: e.jsxs(i.div, {
              ...
              children: [
                e.jsx("h2", {
                  ...
                  children: "Questions About Our Terms?",
                }),
                e.jsx("p", {
                ...
                e.jsxs("div", {
                  ...
                  children: [
                    e.jsxs("div", {
                      ...
                      children: [
                        e.jsx(c, { className: "h-5 w-5 text-blue-200" }),
                        e.jsx("span", {
                          className: "text-blue-100",
                          children: "legal@alnabihospital.com",
                        }),
                      ],
                    }),
                    e.jsxs("div", {
                      className: "flex items-center space-x-2",
                      children: [
                        e.jsx(d, { className: "h-5 w-5 text-blue-200" }),
                        e.jsx("span", {
                          className: "text-blue-100",
                          children: "+91 4 123 4567",
                        }),
                      ],
                    }),
                  ],
