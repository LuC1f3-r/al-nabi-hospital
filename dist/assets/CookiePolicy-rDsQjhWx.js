                ...
                children: [
                  e.jsx("div", {
                    ...
                    children: e.jsx("div", {
                      ...
                      children: e.jsx(w, { className: "h-8 w-8 text-white" }),
                    }),
                  }),
                  e.jsx("h1", {
            ...
            children: e.jsxs(i.div, {
              ...
              children: [
                e.jsxs("h2", {
                  ...
                  children: [
                    e.jsx(r, { className: "h-6 w-6 text-primary-500 mr-2" }),
                ...
                e.jsxs("div", {
                  className:
                    "mt-8 flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4",
                  children: [
                    e.jsx(i.button, {
                      whileHover: { scale: 1.02 },
                      whileTap: { scale: 0.98 },
                      className:
                        "flex-1 bg-primary-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-primary-700 transition-colors",
                    ...
                    e.jsx(i.button, {
                      ...
                      whileTap: { scale: 0.98 },
                      className:
                        "flex-1 bg-gray-200 text-gray-700 px-6 py-3 rounded-xl font-semibold hover:bg-gray-300 transition-colors",
                      children: "Accept All",
                    }),
                  ],
                }),
              ...
              children: [
                e.jsxs("h3", {
                  className:
                    "text-2xl font-bold text-gray-900 mb-6 flex items-center",
                  children: [
                    e.jsx(p, { className: "h-6 w-6 text-amber-500 mr-2" }),
                      ...
                      children: [
                        ...
                        e.jsxs("ul", {
                          ...
                          children: [
                            e.jsxs("li", {
                              children: [
                                e.jsx("strong", { children: "Chrome:" }),
                                " Settings → Privacy and security → Cookies",
                              ],
                            }),
                            e.jsxs("li", {
                              children: [
                                e.jsx("strong", { children: "Firefox:" }),
                                " Options → Privacy & Security → Cookies",
                              ],
                            }),
                            e.jsxs("li", {
                              children: [
                                e.jsx("strong", { children: "Safari:" }),
                                " Preferences → Privacy → Cookies",
                              ],
                            }),
                            e.jsxs("li", {
                              children: [
                                e.jsx("strong", { children: "Edge:" }),
                      ...
                      children: [
                        ...
                        e.jsxs("ul", {
                          ...
                          children: [
                            e.jsxs("li", {
                              children: [
                                e.jsx("strong", { children: "Chrome Mobile:" }),
                                " Settings → Site settings → Cookies",
                              ],
                            }),
                            e.jsxs("li", {
                              children: [
                                e.jsx("strong", { children: "Safari Mobile:" }),
                            ...
                            e.jsxs("li", {
                              children: [
                                ...
                                " Settings → Data Management → Cookies",
                              ],
                            }),
                            e.jsxs("li", {
                              children: [
                                ...
                                " Settings → Sites and downloads → Cookies",
                              ],
                            }),
                          ],
                        }),
                ...
                e.jsxs("div", {
                  ...
                  children: [
                    e.jsxs("div", {
                      className: "flex items-center space-x-2",
                      children: [
                        e.jsx(g, { className: "h-5 w-5 text-blue-200" }),
                        e.jsx("span", {
                          className: "text-blue-100",
                          children: "privacy@alnabihospital.com",
                        }),
                      ],
                    }),
                    e.jsxs("div", {
                      className: "flex items-center space-x-2",
                      children: [
                        e.jsx(b, { className: "h-5 w-5 text-blue-200" }),
                        e.jsx("span", {
                          className: "text-blue-100",
