      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Discover our wide range of medical services, delivered by expert
            specialists using state-of-the-art technology to ensure the highest
            quality care.
          </p>
        </div>
          ...
          <AnimatePresence>
            {displayedServices.map((service, index) => (
              ...
              >
                ...
                >
                  <span>
                    {isNavigating === service.id ? "Loading..." : "Learn More"}
                  </span>
                  <span
                    className={`transition-transform duration-200 ${
                      isNavigating === service.id ? "animate-spin" : ""
                    }`}
                  >
                    {isNavigating === service.id ? "⟳" : "→"}
                  </span>
