...
const ChatWindow: React.FC<ChatWindowProps> = ({ isOpen, onClose }) => {
  ...
  const addMessage = (
    ...
    isBot: boolean = false,
    options?: string[],
    type: "text" | "appointment" | "confirmation" | "error" = "text"
  ) => {
        ...
        default:
          if (departments.includes(option)) {
            ...
            addMessage(
              ...
              }\n\nWould you like to book an appointment with our ${option} team?`,
              true,
        ...
        case 3: // Department
          {
            ...
            addMessage(
              ...
              true,
              [...deptDoctors, "Any Available Doctor"]
            );
          }
          break;
        case 4: // Doctor
    ...
    if (isBookingMode && appointmentStep > 0) {
      ...
      simulateTyping(() => {
        ...
        if (lowerInput.includes("appointment") || lowerInput.includes("book")) {
          ...
          lowerInput.includes("diagnostic")
        ) {
          addMessage(
          ...
          lowerInput.includes("cardiology") ||
          lowerInput.includes("heart") ||
          lowerInput.includes("cardiac")
        ) {
          addMessage(
          ...
          lowerInput.includes("neurology") ||
          lowerInput.includes("brain") ||
          lowerInput.includes("nerve")
        ) {
          addMessage(
          ...
          lowerInput.includes("pediatrics") ||
  ...
  const handleFeedback = (rating: number) => {
    ...
    addMessage(
      `Thank you for rating your experience ${rating}/5 stars! ⭐ Your feedback helps us improve our service. 🙏`,
      true,
      ["Book Appointment", "Our Services", "Contact Information"]
    );
  };
        ...
        <div className="p-4 bg-white border-t border-gray-200 chatbot-input">
          <div className="flex space-x-2">
            ...
            <button
              ...
              className="p-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl hover:from-blue-600 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-md"
            >
